...
Apart from this I also made a commit in the GridLY repository (https://github.com/openlilylib/gridly/commits/master). The work basically involved reproducing the package from snippets repository.

Lastly, I set up this (https://github.com/adl1995/lilypond-sphinx) repository for harvesting `.ly` files and extract documentation from it. This work is still undergoing. I also started to work with Lydoc (https://github.com/Cecca/lydoc), written by Matteo. It makes use of Sphinx and Gecko to extract comments from function headers, it is my opinion to build on top of this current work to avoid reinventing the wheel. 
...
| Time Period        | Plan           |
| ------------- | ------------- |
| May 04, 2017 - May 30, 2017 **(Community Bonding Period)**      |   <ul><li>Finalize on the deliverables.</li><li>Discuss with mentors and get a final idea on how to approach the problem.<li>Conclude on how / where to extract the documentation from.</li></ul>|
| | **Part 1 starts** |
| May 30, 2017 - June 15, 2017 ( 2 weeks ) | <ul><li>Set up the development environment, get familiar with LilyPond's coding practices.</li><li>Write a skeleton layout of the code to implement.</li></ul> |
...
| July 01, 2017 - July 14, 2017 ( 2 weeks ) | <ul><li>Add additional functionalities e.g. ability to generate JSON files, that facilitates user during documentation generation.</li></ul> |
